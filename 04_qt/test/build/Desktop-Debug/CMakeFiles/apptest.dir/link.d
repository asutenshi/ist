apptest: \
  ...
  /usr/lib/libQt6Quick.so.6.9.0 \
  /usr/lib/libQt6QmlMeta.so.6.9.0 \
  /usr/lib/libQt6QmlWorkerScript.so.6.9.0 \
  /usr/lib/libQt6QmlModels.so.6.9.0 \
  /usr/lib/libQt6Qml.so.6.9.0 \
  /usr/lib/libQt6Network.so.6.9.0 \
  /usr/lib/libQt6OpenGL.so.6.9.0 \
